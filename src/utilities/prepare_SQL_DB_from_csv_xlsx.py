...
class Prepare_SQL_from_Tabular_Data:
    ...
    def create_SQL_DB(self):
        ...
        Each file's name (excluding the extension) is used as the table name.The data is saved into the SQLite database referenced by the engine attribute."""
        for file in self.file_list:
            ...
            df.to_sql(file_name,if_exists='replace', index=False)
